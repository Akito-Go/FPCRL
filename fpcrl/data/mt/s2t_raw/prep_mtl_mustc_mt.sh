...
export SRC_LANG=en
export TGT_LANG=de
export SPM_MODEL=/path/to/fpcrl/data/st/s2t_raw/spminfo/mustc/en-de/spm_unigram10000_st.model
export SPM_DICT=/path/to/fpcrl/data/st/s2t_raw/spminfo/mustc/en-de/spm_unigram10000_st.txt

export TEXT_PATH_TRAIN=/path/to/fpcrl/data/st/dataset/MuST-C/en-de/data/train/txt
export TEXT_PATH_DEV=/path/to/fpcrl/data/st/dataset/MuST-C/en-de/data/dev/txt
