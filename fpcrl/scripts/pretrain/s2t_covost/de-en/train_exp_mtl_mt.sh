...
export MT_ROOT=/path/to/fpcrl/data/mt/s2t_raw/spminfo/covost/de-en/mtl_mt
export CKP=/path/to/fpcrl/scripts/saveckp/pretrain/s2t_covost/de-en/exp_mt/avg_last_10_checkpoint.pt
...
fairseq-train ${MT_ROOT} \
	--arch transformer --save-dir ${SAVE_DIR} --restore-file ${CKP} --share-decoder-input-output-embed \
	...
	--keep-last-epochs 10 --patience 5 \
