...
class S2TTransformerEncoder(FairseqEncoder):
    """
    Speech-to-text Transformer encoder that
    consists of input subsampler and Transformer encoder.
    """
    ...
    def _forward(self, src_tokens, src_lengths, return_all_hiddens=False):
        ...
        return {
            ...
            "encoder_fus_out": [x_irr, x_irr_fus],  # T x B x C
            "encoder_cst_out": [x_ful_pur, y_ful_pur],  # T x B x C
            "encoder_padding_mask": [encoder_padding_mask, y_encoder_padding_mask],
...
@register_model_architecture(model_name="s2t_hubert_opr", arch_name="s2t_hubert_opr_pre")
...
@register_model_architecture(model_name="s2t_hubert_opr", arch_name="s2t_hubert_opr_post")
def s2t_hubert_opr_post(args):
