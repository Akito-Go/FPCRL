...
@register_model_architecture(model_name="s2t_hubert", arch_name="s2t_hubert_pre")
...
@register_model_architecture(model_name="s2t_hubert", arch_name="s2t_hubert_post")
def s2t_hubert_post(args):
